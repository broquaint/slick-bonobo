...
SlickBonobo.prototype = {
    connectionHandler: function(socket) {
        ...
        if(allowedIPs.indexOf(remoteAddr) != -1) {
            console.log('Got a request from:', remoteAddr);
        } else {
...
SlickBonobo.ProxyResponse.prototype = {
    ...
    handleResponse: function () {
        console.log('Totally responding to', this.requestUrl, 'with', this.proxyHeaders);
    ...
    endHandler: function() {
//        console.log("Request finished, preparing response ...");
    ...
    jsdomDoneHandler: function(err, window) {
        ...
        console.log("Munging: ", this.requestUrl);
    ...
    updateResponse: function(finalBody) {
        console.log("Updating headers - ", this.requestUrl);
    ...
    finalizeResponse: function(err, outgoingBody) { 
        ...
        console.log("Response body: ", outgoingBody);
        console.log("Response headers: ", this.proxyHeaders);
    }
};
